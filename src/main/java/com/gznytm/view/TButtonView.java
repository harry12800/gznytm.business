...
import com.gznytm.service.TButtonService;
...
public class TButtonView  extends DisplayPanel<TButton> {
 	private static final long serialVersionUID = 1L;
	TButtonService service;
	public TButtonView() {
	}
	@Override
	protected void initMeta(cn.harry12800.j2se.table.DisplayPanel.Meta meta) {
		service = SysConfig.instance.getBean(TButtonService.class);
	}
	@Override
